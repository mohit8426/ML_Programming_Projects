...
df = pd.read_csv("C:/Users/mohit/breast-cancer.csv") 
...
# Calculating accuracy percentage of class row
...
# Evaluate an algorithm using a cross validation split for the class
